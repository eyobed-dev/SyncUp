...
void main() {
  ...
  final meetings = <Map<String, Object?>>[
    ...
    _m('th1', 'Ondřej Vlach', 3, 10, 30, 30, 'BSc', 'Consultation – Formal Languages', 'Room B109'),
    _m('th2', 'Tereza Burešová', 3, 11, 0, 30, 'MIT-EN', 'Mentoring', 'Office 204'),
    _m('th3', 'Filip Kopecký', 3, 11, 30, 30, 'BSc', 'Consultation – Compiler Construction', 'Lab B322'),
    _m('t1', 'Simona Tichá', 3, 15, 30, 15, 'BSc', 'Mentoring', 'Office 204'),
